            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    if (board.castling0()) {
                        ...
                        System.out.println("Рокировка не удалась. "+board.getReason());
                    }
                    ...
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn)) {
                            ...
                            board.printBoard();
                        } else System.out.println("Передвижение не удалось. "+board.getReason());
                    } catch (Exception e) {
                        System.out.println("Вы что-то ввели не так, попробуйте ещё раз. "+board.getReason());
                    }
